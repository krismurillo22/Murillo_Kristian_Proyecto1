 ...
 * @author User
 */
public class AtaqueVisual extends javax.swing.JFrame {

    /**
     * Creates new form AtaqueVisual
     */
    public AtaqueVisual(LogicaFichas atacante, LogicaFichas defensor, int ganaAtacante) {
        initComponents();
